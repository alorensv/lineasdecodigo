          ...
          <div class="carousel-item">
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p>Obtén toda la información que requieres de manera inmediata, siempre disponible y al alcance de tu bolsillo, actualiza tu página web, administra tus ventas, realiza cotizaciones, obtén reportes y mucho más.</p>
...
<div class="container">
    <div class="row featurette">
        ...
        <div class="col-md-5" style="padding-top: 15px;padding-bottom: 15px;color: white;">
                ...
                <section class="shadow-lg" style=" background-color: #5da0d2;" id="contacto"> 
...
<section class="clientes">
        <div class="container">
          <div class="texto-cotiza">
            <h2 class="featurette-heading">Nuestros <span class="text-muted">confían en Nosotros</span><i class="bi bi-chevron-right"></i></h2>
          </div>

          <div id="counter" class="row counter-style">
            <div class="col-md-3 box" style="border-right: 1px solid #ccc;">
              <b class="counter-value" data-count="6">6</b>
              <span>Años de experiencia</span>
            </div>
            <div class="col-md-3 box" style="border-right: 1px solid #ccc;">
              <b class="counter-value" data-count="15">+15</b>
              <span>Tecnologías que usamos</span>
            </div>
            <div class="col-md-3 box" style="border-right: 1px solid #ccc;">
            ...
            <div class="col-md-3 box" style="border-right: 1px solid #ccc;">
              <b class="counter-value" data-count="9999">+1000</b>
              <span>Líneas de código</span>
            </div>
          </div>


          <div class="row" style=" padding: 75px 0 80px 0;">
